...
//SQL get service data query
$service_list='';
$query="SELECT * FROM service WHERE is_service=0 ORDER BY serviceID";

$service=mysqli_query($conp,$query);

//fill service details to table

if($service){
    while($service1=mysqli_fetch_assoc($service)){

        $service_list.="<tr>";
        $service_list.="<td>{$service1['serviceID']}</td>";
        $service_list.="<td>{$service1['serviceName']}</td>";
        $service_list.="<td><a href=\"viewService.php?id={$service1['serviceID']}\"> <button class='btn btn-info btn-sm'>View</button></a></td>";
        $service_list.="<td><a href=\"modify-service.php?id={$service1['serviceID']}\"> <button class='btn btn-primary btn-sm'>Edit</button></a></td>";
        $service_list.="<td><a href=\"delete-service.php?id={$service1['serviceID']}\"><button class='btn btn-danger btn-sm'>Deactive</button></a></td>";
        $service_list.="</tr>";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="col-md-5" >
                            <div>
                               <a href="add-service.php"><button type="button" class="btn btn-warning">  Add  </button></a>
                            </div>
                </div>
