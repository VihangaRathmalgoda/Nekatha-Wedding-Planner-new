...
$provider_list='';
$query="select * from regiProvider WHERE is_provider=0 ";

$provider=mysqli_query($conp,$query);

//fill providers details to table

if($provider){
    while($provider1=mysqli_fetch_assoc($provider)){

        $provider_list.="<tr>";
        $provider_list.="<td>{$provider1['regiProviderID']}</td>";
        $provider_list.="<td>{$provider1['providerName']}</td>";
        //$provider_list.="<td>{$provider1['providerContactNo']}</td>";
        //$provider_list.="<td>{$provider1['providerEmail']}</td>";
        //$provider_list.="<td><button onclick=\"window.location.href='viewProvider.php'\">View</button></td>";
        $provider_list.="<td><a href=\"viewProvider.php?id={$provider1['regiProviderID']}\"><button class='btn btn-primary btn-sm'>View</button></a></td>";
        // $provider_list.="<td><a href=\"modify-provider.php?id={$provider1['regiProviderID']}\"><button>Edit</button></a></td>";
        $provider_list.="<td><a href=\"delete-provider.php?id={$provider1['regiProviderID']}\"><button class='btn btn-danger btn-sm'>Deactive</button></a></td>";
        $provider_list.="</tr>";
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Providers</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    ...
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover th-sm">
                            <thead>
                                <tr>
