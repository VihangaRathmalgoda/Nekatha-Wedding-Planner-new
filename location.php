...
$location_list='';
$query="select * from place WHERE is_place='1'";

$location=mysqli_query($conp,$query);

//fill providers details to table

if($location){
    while($location1=mysqli_fetch_assoc($location)){

        $location_list.="<tr>";
        $location_list.="<td>{$location1['placeID']}</td>";
        $location_list.="<td>{$location1['name']}</td>";
        $location_list.="<td>{$location1['location']}</td>";
        $location_list.="<td><a href=\"viewLocation.php?id={$location1['placeID']}\"> <button class='btn btn-info btn-sm'>View</button></a></td>";
        $location_list.="<td><a href=\"deleteLocation.php?id={$location1['placeID']}\"><button class='btn btn-danger btn-sm'>Deactive</button></a></td>";
        $location_list.="</tr>";
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <!-- add location button -->
                    <div class="col-md-5" >
                            <div>
                            <a href="addLocation.php"><button type="button" class="btn btn-warning">  Add  </button></a>
                            </div>
                    </div>
                <!-- table -->
                <div class="row my-5">
