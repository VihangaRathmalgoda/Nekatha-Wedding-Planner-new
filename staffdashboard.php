...
if($staff){
    while($staff1=mysqli_fetch_assoc($staff)){
        ...
        $staff_list.="<td><a href=\"modify-admindashboard.php?id={$staff1['staffID']}\">   <button class='btn btn-primary btn-sm'>Edit</button></a></td>";
        $staff_list.="<td><a href=\"delete-member.php?id={$staff1['staffID']}\"><button class='btn btn-danger btn-sm'>Deactivate</button></a></td>";
        $staff_list.="</tr>";
    }
 }
 else{
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <div class="row g-3 my-2">
                    ...
                    <div class="col-md-5" >
                            <div>
                            <a href="add-staff.php"><button type="button" class="btn btn-warning">  Add  </button></a>
                            </div>
                    </div>
